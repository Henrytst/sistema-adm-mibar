...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-10">
                <a href="./API/views/preparo.php"><button type="button" class="btn btn-success">Cadastrar
                        Preparo</button></a>
                <hr>
            </div>
        </div>
                    ...
                    <table class="table table-striped w-100" id="table_id">
                        <thead>
                            <tr>
                                ...
                                <th class="preco" scope="col">preço</th>
                                <th scope="col">Status</th>
                                <th class="acoesPreparo" scope="col">AÇÕES</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="preco">R$ <?= number_format($value->preco, '2', ',', '.'); ?></td>
                                    <td><?= $value->status; ?></td>
                                    <td class="acoesPreparo"><a href="./API/views/preparo.php?id=<?= $value->id; ?>&acao=buscar"><button type="button" class="apagarTexto btn btn-warning btn-sm acoesPreparo"><span class="bi bi-eye-fill"></span> Visualizar/Editar</button></a>
                                        <button type="button" class="apagarTexto btn btn-danger btn-sm acoesPreparo" data-toggle="modal" data-target="#excluir<?= $value->id; ?>"><span class="bi bi-trash-fill"></span> Excluir</button>
                                    </td>
                                </tr>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Deseja realmente excluir o Preparo
                                                <b><?= $value->name; ?>?</b>
                                            </div>
