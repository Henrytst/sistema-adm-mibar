...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                <h1 class="display-6">Fornecedor</h1>
            </div>
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-10">
                <a href="./API/views/fornecedor.php"><button type="button" class="btn btn-success">Cadastrar
                        Fornecedor</button></a>
                <hr>
            </div>
        </div>
        <?php
        require_once("./API/model/fornecedor.php");
        $listar = new Fornecedor();
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= substr_replace($value->produto, (strlen($value->produto) > 30 ? '...' : ''),30);; ?></td>
                                    <td>R$ <?= number_format($value->preco, '2', ',', '.'); ?></td>
                                    <td class="acoes"><a href="./API/views/fornecedor.php?id=<?= $value->id; ?>&acao=buscar"><button type="button" class="apagarTexto btn btn-warning btn-sm acoes"><span class="bi bi-eye-fill"></span> Visualizar/Editar</button></a>
